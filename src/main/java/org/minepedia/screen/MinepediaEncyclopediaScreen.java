...
public final class MinepediaEncyclopediaScreen extends MinepediaScreen {
    ...
    public MinepediaEncyclopediaScreen() {
        super(
                ...
                new MinepediaMenuWidget.MinepediaMenuItem(MinepediaMenuWidget.MinepediaSection.ENCYCLOPEDIA, "nether_portal", new MinepediaMenuWidget.ImageData("nether_portal", 512, 512, MinepediaMenuWidget.ImagePosition.END, 90)),
                ...
                new MinepediaMenuWidget.MinepediaMenuItem(MinepediaMenuWidget.MinepediaSection.ENCYCLOPEDIA, "scaffolding", new MinepediaMenuWidget.ImageData("scaffolding", 512, 512, MinepediaMenuWidget.ImagePosition.END, 170)),
